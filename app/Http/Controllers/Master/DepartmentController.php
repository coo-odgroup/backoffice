...
class DepartmentController extends Controller
{
    ...
    public function dataTableView()
    {
        ...
        try {
            ...
            $dataQuery = DB::table('mst_departments as m')
                ->select(
    ...
    public function add($encId = null)
    {
        ...
        try {
            ...
            if ($id > 0) {
                ...
                $redirectPage = route('department.edit', $encId);

                $data['strPage']   = $method = 'Edit';
                $data['strSubmit'] = 'Update';
                $data['strReset']  = 'Cancel';

                $dataResQry = DB::table('mst_departments')
                    ->select(
                        'id',
                        'department_name',
                        'department_code',
                ...
                $id = 0;
                $redirectPage = route('department.index');
            }
            ...
            if (request()->isMethod('post')) {
                ...
                $duplicateName = DB::table('mst_departments')
                ...
                $duplicateCode = DB::table('mst_departments')
