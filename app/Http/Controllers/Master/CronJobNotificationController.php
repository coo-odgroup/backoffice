...
class CronJobNotificationController extends Controller
{
    public function index()
    {
        return view('Master.viewCronJobNotification');
    }
    ...
    public function add($encId = null)
    {
        ...
        return view('Master.addCronJobNotification', compact('data'));
    }
