        ...
        try {
            ...
            if (request()->isMethod('post')) {
                ...
                if ($duplicate->exists()) {
                    ...
                    return back()->with([
                        'level' => 'danger',
                        'message' => 'This user has already been assigned the selected role.'
                    ])->withInput();
                }
                ...
                if ($id != 0) {
                    ...
                    $row = [
                        ...
                        'organization_type_id' => request('org'),
                        'organization_id'      => request('organization'),

                        'branch_id'            => request('branch_id') ?: null,
                        'department_id'        => request('department_id') ?: null,

                        'is_primary'           => request()->has('isPrimary') ? 1 : 0,
