    ...
    public function add($encId = null)
    {
        ...
        try {
            ...
            if ($id > 0) {
                ...
                $redirectPage = "admin/organization/edit/" . $encId;
                ...
                $redirectPage = "admin/organization";
            }
            ...
            if (request()->isMethod('post')) {
                ...
                if (request()->hasFile('logo')) {
                    ...
                    $file->move(public_path('uploads/organization'), $logoName);
                } elseif ($id > 0) {
        ...
        return view('Master.addOrganization', compact('data'));
    }
