...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('Ads.add') }}" class="btn btn-success btn-sm">
            ...
            <div class="mb-1 border-bottom d-none" id="filterBox">
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <!-- Buttons -->
                        <div class="col-lg-5 col-md-3 d-flex justify-content-end flex-wrap action-btns gap-1 mt-1">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if (data) {
                        return `<img src="{{ asset('storage/uploads/Ad/Ads') }}/${data}"width="60" height="40"style="object-fit:cover;">`;
                    }
                    return "--";
                }
            },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        href="${editUrl.replace('ID', row.enc_ads_id)}">
