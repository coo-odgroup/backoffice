...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('pricingPlan.add') }}" class="btn btn-success btn-sm">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <input type="hidden" id="hdn_model" value="PricingPlan">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<div class="checkbox"><input class="inverted chkItem" type="checkbox" id="check' + row.pricing_plan_id +
                        '" name="chkStd' + row.pricing_plan_id + '" value="' + row.pricing_plan_id +
                        '" ></div>';
                },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        href="${editUrl.replace('ID', row.enc_pricing_plan_id)}">
                        <i class="fa fa-edit"></i> Edit
                        </a>

                        <a href="javascript:void(0);"
                            class="btn btn-sm btn-success btn-view-log"
                            data-table="ad_pricing_plans"
                            data-id="${row.enc_pricing_plan_id}">
