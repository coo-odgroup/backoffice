                                            ...
                                            <div class="p-3 border rounded bg-white">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control clearable form-select-sm" id="tag_name" name="tag_name"
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control clearable form-select-sm" id="slug" name="slug"
                                                            value="{{ $data['row']->slug ?? '' }}"
