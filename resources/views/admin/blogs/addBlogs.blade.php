                                                    ...
                                                    <div class="row">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="blogAuthor">Author <span class="text-danger">*</span></label>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="seoSection6"
                                                    ...
                                                    <div id="faqContainer">
                                                        ...
                                                        @php
                                                        $faqOldQuestions = old('faq_question', []);
                                                        $faqOldAnswers = old('faq_answer', []);
                                                        @endphp

                                                        {{-- EDIT/VALIDATION OLD DATA --}}
                                                        @if(count($faqOldQuestions) > 0)

                                                        @foreach($faqOldQuestions as $index => $question)
                                                            ...
                                                            <div class="p-3 border rounded bg-white h-100" style="margin: 10px 10px 10px 10px;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-0">
                                                                        <label><span class="faq-count">{{ $index + 1 }}</span>. FAQ - Answer</label>
                                                                        <textarea class="form-control clearable form-select-sm faq-answer"
                                                                            name="faq_answer[]"
                                                                            rows="4"
                                                                            placeholder="Enter FAQ Answer">{{ $faqOldAnswers[$index] ?? '' }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        {{-- EDIT MODE FAQ FROM blog_faq TABLE --}}
                                                        @elseif(isset($blogFaqs) && count($blogFaqs) > 0)

                                                        @foreach($blogFaqs as $index => $faq)
                                                        <div class="faq-row mb-3">
                                                            <div class="p-3 border rounded bg-white h-100" style="margin: 10px 10px 10px 10px;">
                                                                <div class="row align-items-end mb-3">
                                                                    <div class="col-md-11">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-0">
                                                                        ...
                                                                        <textarea class="form-control clearable form-select-sm faq-answer"
                                                                            name="faq_answer[]"
                                                                            rows="4"
                                                                            placeholder="Enter FAQ Answer">{{ $faq->faq_answer }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="faq-row mb-3">
                                                            <div class="p-3 border rounded bg-white h-100" style="margin: 10px 10px 10px 10px;">
                                                                <div class="row align-items-end mb-3">
                                                                    <div class="col-md-10">
                                                                        <label><span class="faq-count">1</span>. FAQ - Question</label>
                                                                        <input type="text"
                                                                            class="form-control clearable form-select-sm faq-question"
                                                                            name="faq_question[]"
                                                                            placeholder="Enter FAQ Question"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-0">
                                                                        <label><span class="faq-count">1</span>. FAQ - Answer</label>
                                                                        <textarea class="form-control clearable form-select-sm faq-answer"
                                                                            name="faq_answer[]"
                                                                            rows="4"
    ...
    <script type="module">
        ...
        document.getElementById('title').addEventListener('input', function() {
            ...
            document.getElementById('canonical_url').value = frontUrl + '/blog/' + alias;
        ...
        $(document).ready(function() {
            ...
            commonAjax.initSelect2('#blogAuthor', 'Select Author');

            let author_id = <?= $data['row']->author_id ?? '0' ?>;
        ...
        function updateFaqCounters() {
            $('#faqContainer .faq-row').each(function(index) {
                const count = index + 1;

                $(this).find('.faq-count').each(function() {
                    $(this).text(count);
                });
            });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            faqContainer.addEventListener('click', function(e) {
                ...
                <div class="p-3 border rounded bg-white h-100" style="margin: 10px 10px 10px 10px;">
                    <div class="row align-items-end mb-3">
                        <div class="col-md-10">
                            <label><span class="faq-count"></span>. FAQ - Question </label>
                            <input type="text"
                                class="form-control clearable form-select-sm faq-question"
                                name="faq_question[]"
                                placeholder="Enter FAQ Question">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-0">
                            <label><span class="faq-count"></span>. FAQ - Answer </label>
                            <textarea class="form-control clearable form-select-sm faq-answer"
                                name="faq_answer[]"
                                rows="4"
                                placeholder="Enter FAQ Answer"></textarea>
            ...
            `;
                ...
                if (e.target.closest('.btn-remove')) {
                    const faqRows = faqContainer.querySelectorAll('.faq-row');
        ...
        $(document).on('change', 'input[name^="article["]', function() {
            generateServiceSchema();
        });
        ...
        function generateBreadcrumbSchema() {
            ...
            const alias = $('#blogAlias').val().trim();
            const frontUrl = "{{ rtrim(config('constants.CONSUMER_FRONT_URL'), '/') }}";
            const canonicalUrl = frontUrl + "/blog/" + alias;

            // keep canonical textbox in sync
            $('#canonical_url').val(canonicalUrl);

            commonAjax.getSchemaContent("Blog", "Breadcrumb", function(response) {
                ...
                try {
                    schema = schema
                        ...
                        .replaceAll("__BLOG_HOME_URL__", frontUrl + "/blog")
                        .replaceAll("__BLOG_URL__", canonicalUrl);
        ...
        function generateServiceSchema() {
            ...
            // Thumb image URL
            let thumbImageUrl = '';
            const thumbPreview = $('#prv_1').attr('src') || '';
            if (thumbPreview && thumbPreview !== '#' && !thumbPreview.startsWith('data:image')) {
                thumbImageUrl = thumbPreview;
            }

            // Featured image URL
            let featuredImageUrl = '';
            const featuredPreview = $('#prv_2').attr('src') || '';
            if (featuredPreview && featuredPreview !== '#' && !featuredPreview.startsWith('data:image')) {
                featuredImageUrl = featuredPreview;
            }

            commonAjax.getSchemaContent("Blog", "Service", function(response) {

                console.log("Service schema response =>", response);
                ...
                schema = schema
                    .replaceAll("__BASE_URL__", frontUrl)
                    .replaceAll("__HEAD_LINE__", title)
                    .replaceAll("__DESCRIPTION__", description)
                    .replaceAll("__THUMB_IMAGE_URL__", thumbImageUrl)
                    .replaceAll("__FEATURED_IMAGE_URL__", featuredImageUrl)
                    .replaceAll("__AUTHOR_NAME__", authorName === 'Select Author' ? '' : authorName)
                    .replaceAll("__AUTHOR_URL__", authorUrl)
                    .replaceAll("__OD_BUS_LOGO__", "https://provider.odbus.co.in/public/uploads/logo/1617067813-logo.png")
                    .replaceAll("__DATE_PUBLISHED__", publishedDate);

                try {
                    const prettyJson = JSON.stringify(JSON.parse(schema), null, 4);
                    $('#service_schema').val(prettyJson);
                } catch (e) {
                    console.error("Invalid Service Schema JSON", e);
                    $('#service_schema').val(schema);
                }
            });
        }
        ...
        function generateFaqSchema() {
            ...
            commonAjax.getSchemaContent("Blog", "FAQ", function(response) {

                console.log("FAQ schema response =>", response);
                ...
                let schemaTemplate = response.data.schema_content;
                let faqJson = null;

                try {
                    faqJson = JSON.parse(schemaTemplate);
                } catch (e) {
                    console.error("Invalid FAQ schema template JSON", e);
                    $('#faq_schema').val(schemaTemplate);
                    return;
                }

                // Build FAQ items dynamically from all FAQ rows
                let faqItems = [];
                ...
                faqJson.mainEntity = faqItems;

                try {
                    const prettyJson = JSON.stringify(faqJson, null, 4);
                    $('#faq_schema').val(prettyJson);
                } catch (e) {
                    console.error("Error while generating FAQ schema", e);
                    $('#faq_schema').val(JSON.stringify(faqJson));
                }
            });
        }
    </script>
