...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('blog-tag-map.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm" id="datatable"
                    data-url="{{ route('blog-tag-map.dataTableView') }}"
                    data-edit-url="{{ route('blog-tag-map.edit', 'ID') }}">
            ...
            <input type="hidden" id="hdn_model" value="BlogTagMap">
...
<script type="module">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: (d, t, r) =>
                    `<div class="checkbox"><input class="chkItem" type="checkbox" value="${r.tag_map_id}"></div>`
            },
            {
                data: 'slNo',
