                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-lg-9 col-md-9 mb-2">
                            ...
                            <input type="text" class="form-control clearable form-control-sm" id="txtSearch" name="txtSearch" placeholder="Blog Routes">
                        </div>
...
<script type="module">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: (d, t, r) =>
                    `<div class="checkbox"><input class="chkItem" type="checkbox" value="${r.blog_routes_id}"></div>`
            },
            {
                data: 'slNo',
