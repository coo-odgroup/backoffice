<div class="bg-white border-end" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <div class="collapse {{ Request::is('admin/states*','admin/user-roles','admin/department*','admin/department-type*','admin/branch-type*','admin/branch*','admin/district*','admin/cities*','admin/bustype*','admin/seatingtype*','admin/amenitycategory*','admin/amenities*','admin/roles*','admin/roles-hierarchy*','admin/reason*','admin/modules*','admin/boardingDropping*','admin/apiapps*','admin/apikeys*','admin/cityapis*','admin/users*','admin/brand*','admin/bus-model*','admin/axle-type*','admin/bus-service*','admin/mst-seatlayout*','admin/annexture-type','admin/annexture','admin/cancellationslab*','admin/cancellationslab-info*','admin/seat-layout*','admin/festive-days*','admin/ticket-fare-slab*','admin/ticketfareslab-info*','admin/bus-schedule*','admin/bus-cancel*','admin/seat-block*','admin/seat-open*','admin/notification-template*','admin/bus','admin/cron-job','admin/notification-rules*', 'schema*') ? 'show' : '' }}" id="busManagement">
            ...
            <a href="{{ url('admin/department-type') }}"
                class="list-group-item list-group-item-action ps-4 {{ Request::is('admin/department-type*') ? 'active' : '' }}">
                <i class="fa-solid fa-building-user me-2"></i>Department Type
            </a>
            ...
            <a href="{{ url('admin/users') }}"
             ...
             <a href="{{ url('admin/user-roles') }}"
                class="list-group-item list-group-item-action ps-4 {{ Request::is('admin/user-roles*') ? 'active' : '' }}">
                <i class="fa-solid fa-user-group me-2"></i> User Roles
            </a>
