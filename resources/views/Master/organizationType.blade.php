...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('organization-type.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                    data-url="{{ route('organization-type.dataTableView') }}"
                    data-edit-url="{{ route('organization-type.edit', 'ID') }}">
                    <thead class="table-secondary">
                        <tr>
                            ...
                            <th>Can Have Branches</th>
                            <th>Can Have Employees</th>
                            <th>Can Sell Tickets</th>
                            <th>Last Modified</th>
                            <th>Status</th>
            ...
            <input type="hidden" id="hdn_model" value="OrganizationType">
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        <a href="javascript:void(0);"
                            ...
                            data-table="mst_organization_types"
                            data-id="${row.enc_id}">
