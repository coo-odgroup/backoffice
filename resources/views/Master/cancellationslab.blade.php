...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('cancellationslab.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm" id="datatable"
                    data-url="{{ route('cancellationslab.dataTableView') }}"
                    data-edit-url="{{ route('cancellationslab.edit', 'ID') }}">
            ...
            <input type="hidden" id="hdn_model" value="Cancellationslab">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<input class="form-check-input chkItem" type="checkbox" id="check' + row.slab_id +
                        '" name="chkStd' + row.slab_id + '" value="' + row.slab_id +
                        '" >';
                },
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        <a href="javascript:void(0);"
                            ...
                            data-table="mst_cancellationslab"
