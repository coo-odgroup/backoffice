...
@section('page_title', 'Review Category')
@section('content')
...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('reviewcategory.add') }}" class="btn btn-success btn-sm">
...
<form id="backoffice-form" name="backoffice-form" method="post" novalidate>
    <div class="card">
        <div class="card-body">
            ...
            <input type="hidden" id="hdn_model" value="ReviewCategory">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<input class="form-check-input chkItem" type="checkbox" id="check' + row.review_cat_id +
                        '" name="chkStd' + row.review_cat_id + '" value="' + row.review_cat_id +
                        '" >';
                },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `<input type="text"
                            ...
                            data-id="${row.enc_review_cat_id}"
                            data-table="mst_review_categories"
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        href="${editUrl.replace('ID', row.enc_review_cat_id)}">
