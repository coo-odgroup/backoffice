...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('cancellationslab-info.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm" id="datatable"
                    data-url="{{ route('cancellationslab-info.dataTableView') }}"
                    data-edit-url="{{ route('cancellationslab-info.edit', 'ID') }}">
            ...
            <input type="hidden" id="hdn_model" value="CancellationslabInfo">
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        <a href="javascript:void(0);"
                            ...
                            data-table="mst_cancellationslab_info"
