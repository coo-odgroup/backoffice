    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('department.add') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                        data-url="{{ route('department.dataTableView') }}"
                        data-edit-url="{{ route('department.edit', 'ID') }}">
                    ...
                    <input type="hidden" id="hdn_model" value="Department">
