    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('documentType.add') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end mb-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                                <label for="txtSearch" class="form-label">Search By Document</label>
                                <input
                                    type="text"
                                    class="form-control form-control-sm"
                                    id="txtSearch"
                                    name="txtSearch"
                                    placeholder="Enter Document Name / Code"
                                    autocomplete="off">
                            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                        data-url="{{ route('documentType.dataTableView') }}"
                        data-edit-url="{{ route('documentType.edit', 'ID') }}">
                    ...
                    <input type="hidden" id="hdn_model" value="DocumentType">
    ...
    <script type="module">
        ...
        window.getDataTableView = function(reset = true) {
            ...
            let displayColumns = [1, 2, 3, 4, 5, 6, 7, 8];
            let dataTableColumns = [{
                    data: '',
                    render: function(data, type, row) {
                        return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.documentType_id +
                            '" name="chkStd' + row.documentType_id + '" value="' + row.documentType_id +
                            '" ></div>';
                    },
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            ...
                            href="${editUrl.replace('ID', row.enc_documentType_id)}">
                            <i class="fa fa-edit"></i>
                            </a>

                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-success btn-view-log"
                                data-table="mst_document_types"
                                data-id="${row.enc_documentType_id}">
