...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('branch.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                    data-url="{{ route('branch.dataTableView') }}"
                    data-edit-url="{{ route('branch.edit', 'ID') }}">
            ...
            <input type="hidden" id="hdn_model" value="Branch">
...
<script type="module">
        ...
        let dataTableColumns = [

            {
                ...
                render: function(data, type, row) {
                    return '<div class="checkbox"><input class="inverted chkItem" type="checkbox" id="check' +
                        row.branch_id +
                        '" name="chkStd' +
                        row.branch_id +
                        '" value="' +
    ...
    $(document).on('click', '.btnViewBranch', function() {
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Opening Date</th>
                            <td>${res.opening_date??''}</td>
                        </tr>
                        <tr>
                            <th>Head Office</th>
                            <td>${res.is_head_office==1?'Yes':'No'}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Status</th>
                            <td>${res.active_status==1?'Active':'Inactive'}</td>
                       </tr>
                    </table>
                </div>
            </div>
            `;
            $('#branchDetailsBody').html(html);
        });
    });
</script>
@endpush