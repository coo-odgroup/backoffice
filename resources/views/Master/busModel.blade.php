    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('busModel.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end g-2">
                            ...
                            <div class="col-lg-2 col-md-6">
                                ...
                                <select class="form-select form-select-sm" id="brandSearch" name="brandSearch">
                ...
                <div class="table-responsive">
                    ...
                    <input type="hidden" id="hdn_model" value="BusModel">
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            ...
                            href="${editUrl.replace('ID', row.enc_model_id)}">
