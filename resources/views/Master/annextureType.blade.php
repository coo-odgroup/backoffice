    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('annextureType.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <input type="hidden" id="hdn_model" value="AnnextureType">
        ...
        window.getDataTableView = function(reset = true) {
            ...
            let dataTableColumns = [{
                    ...
                    render: function(data, type, row) {
                        return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.annextureType_id +
                            '" name="chkStd' + row.annextureType_id + '" value="' + row.annextureType_id +
                            '" ></div>';
                    },
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            ...
                            href="${editUrl.replace('ID', row.enc_annextureType_id)}">
                            <i class="fa fa-edit"></i> Edit
                            </a>

                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-success btn-view-log"
                                data-table="mst_annexture_type"
                                data-id="${row.enc_annextureType_id}">
