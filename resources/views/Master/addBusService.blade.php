...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        <a href="{{ route('busService.index') }}" class="btn btn-success btn-sm">
...
<script type="module">
    ...
    $('#backoffice-form').on('submit', function(e) {
        ...
        e.preventDefault();
        if (!validator.blankCheck('busService', 'Bus Service Name cannot be left blank'))
            return false;
        if (!validator.maxLength('busService', 100, 'Axle Type Name'))
            return false;
