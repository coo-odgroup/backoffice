    ...
    @section('page_title', 'Department Type')
    @section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('department-type.add') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end mb-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                                <label for="txtSearch">Search Department</label>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                        data-url="{{ route('department-type.dataTableView') }}"
                        data-edit-url="{{ route('department-type.edit', 'ID') }}">
                    ...
                    <input type="hidden" id="hdn_model" value="DepartmentType">
            ...
            let dataTableColumns = [{
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<div class="checkbox">' +
                            '<input class="chkItem" type="checkbox" id="check' +
                            row.department_id +
                            '" value="' +
                            row.department_id +
                            '">' +
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="javascript:void(0)"
                            ...
                            data-table="mst_department_type"
