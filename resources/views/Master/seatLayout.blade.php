...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('seatlayout.add') }}" class="btn btn-success btn-sm">
            + Add Seat layout
        </a>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6 col-sm-6 col-md-6  col-lg-2 mb-2">
                                    ...
                                    <input type="text" class="form-control clearable" id="txtSearch" name="txtSearch"
            ...
            <div class="table-responsive">
                ...
                <input type="hidden" id="hdn_model" value="BusType">
