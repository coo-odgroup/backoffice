...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('modules.add') }}" class="btn btn-success btn-sm">
            + Add Module
        </a>
    </div>
</div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm" id="datatable"
                    data-url="{{ route('modules.dataTableView') }}"
                    data-edit-url="{{ route('modules.edit', 'ID') }}">
                ...
                <input type="hidden" id="hdn_model" value="Modules">
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.module_id +
                        '" name="chkStd' + row.module_id + '" value="' + row.module_id +
                        '" ></div>';
                },
