        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div>
                ...
                <a href="{{ route('bus-cancel.add') }}" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered align-middle table-sm table-responsive"
                            id="datatable" data-url="{{ route('bus-cancel.dataTableView') }}"
                            data-edit-url="{{ route('bus-cancel.edit', 'ID') }}">
                ...
                let dataTableColumns = [{
                        ...
                        render: function(data, type, row) {
                            return '<div class="checkbox"><input class="inverted chkItem" type="checkbox" id="check' +
                                row.bus_cancel_id +
                                '" name="chkStd' + row.bus_cancel_id + '" value="' + row.bus_cancel_id +
                                '" ></div>';
                        },
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `
                                ...
                                href="${editUrl.replace('ID', row.enc_bus_cancel_id)}">
                                <i class="fa fa-edit"></i> Edit
                                </a>

                                <a href="javascript:void(0);"
                                    class="btn btn-sm btn-success btn-view-log"
                                    data-table="bus_cancelled"
                                    data-id="${row.enc_bus_cancel_id}">
