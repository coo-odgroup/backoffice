    ...
    @section('page_title', 'Bus Service')
    @section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div>
            ...
            <a href="{{ route('excel.add') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                        data-url="{{ route('excel.dataTableView') }}"
                        data-edit-url="{{ route('excel.edit', 'ID') }}">
                    ...
                    <input type="hidden" id="hdn_model" value="BusService">
        ...
        window.getDataTableView = function(reset = true) {
            ...
            let dataTableColumns = [{
                    ...
                    render: function(data, type, row) {
                        return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.busService_id +
                            '" name="chkStd' + row.busService_id + '" value="' + row.busService_id +
                            '" ></div>';
                    },
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            ...
                            href="${editUrl.replace('ID', row.enc_busService_id)}">
                            <i class="fa fa-edit"></i>
                            </a>

                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-success btn-view-log"
                                data-table="mst_bus_service"
                                data-id="${row.enc_busService_id}">
