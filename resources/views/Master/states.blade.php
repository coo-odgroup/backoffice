    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm table_mob table-responsive" id="datatable"
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.state_id +
