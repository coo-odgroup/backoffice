...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div>
        ...
        <a href="{{ route('annexture.add') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle table-sm table-responsive" id="datatable"
                    data-url="{{ route('annexture.dataTableView') }}"
                    data-edit-url="{{ route('annexture.edit', 'ID') }}">
                    <thead class="table-secondary">
                        <tr>
                            ...
                            <th>Sl No</th>
                            <th>Annexture Type</th>
                            <th>Annexture Name</th>
                            <th>Annexture Value</th>
                            <th>Last Modefied</th>
                            <th>Status</th>
                ...
                <input type="hidden" id="hdn_model" value="Annexture">
...
<script type="module">
    ...
    $(document).ready(function() {
        ...
        commonAjax.loadAnnexureTypeList();
        getDataTableView();
    });
    ...
    window.getDataTableView = function(reset = true) {
        ...
        let searchParams = {
            selAnnexureType: $('#selAnnexureType').val() || 0,
            txtSearch: $('#txtSearch').val() || '',
            selStatus: $('#selStatus').val() || '',
        ...
        let dataTableColumns = [{
                ...
                render: function(data, type, row) {
                    return '<div class="checkbox"><input class="chkItem" type="checkbox" id="check' + row.ann_id +
                        '" name="chkStd' + row.ann_id + '" value="' + row.ann_id +
                        '" ></div>';
                },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        ...
                        href="${editUrl.replace('ID', row.enc_ann_id)}">
                        <i class="fa fa-edit"></i>
                        </a>

                        <a href="javascript:void(0);"
                            class="btn btn-sm btn-success btn-view-log"
                            data-table="mst_annexture"
                            data-id="${row.enc_ann_id}">
